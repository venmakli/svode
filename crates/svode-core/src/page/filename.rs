...
pub fn allocate_available_path(
    parent: &Path,
    projection: &FilenameProjection,
    extension: Option<&str>,
) -> Result<(PathBuf, FilenameProjection), PageError> {
...
pub fn component_conflicts_portably(
    parent: &Path,
    candidate: &str,
...
pub fn component_name(stem: &str, extension: Option<&str>) -> String {
    match extension {
