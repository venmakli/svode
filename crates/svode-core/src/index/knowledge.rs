...
use crate::index::resolver::SpaceStatus;
...
use crate::index::model::KnowledgeAgentApplicability;

pub use crate::index::knowledge_artifact::is_agent_context_source;

use crate::index::knowledge_rows::read_agent_applicability;
...
mod utf8_tests {
    ...
    #[test]
    fn related_context_budget_never_splits_codepoint() {
        assert_eq!(utf8_prefix("a🙂b", 4), ("a", true));
        assert_eq!(utf8_prefix("a🙂b", 5), ("a🙂", true));
    }
}
