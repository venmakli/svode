...
use svode_core::index::model::KnowledgeAgentApplicability;
#[cfg(test)]
use svode_core::index::model::{KnowledgeArtifact, KnowledgeEdgeArtifact};
...
async fn scoped_keys(
    ...
    match scope {
        ...
        Some(KnowledgeScope::Project) | None => {
            ...
            let cache = state.core.spaces_cache.lock().await;
