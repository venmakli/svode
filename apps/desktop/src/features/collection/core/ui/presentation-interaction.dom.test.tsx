...
import type { CollectionCoreActivationContext } from "../model/types";
...
test("structured core rows activate from the row and keyboard, preserve nested controls, and expose the context menu", async () => {
  const dom = new JSDOM(
  ...
  const activations: CollectionCoreActivationContext[] = [];
