...
function createProjectAggregateFixture(
  ...
  descriptor: CollectionCorePresentationDescriptor<ProjectActorRow>;
  ...
  const descriptor: CollectionCorePresentationDescriptor<ProjectActorRow> = {
    create: {
  ...
  const presentation = defineCollectionCorePresentation({
    descriptor,
    state: {
...
function createLocalFixture(): {
  detailRequests: CollectionDetailRequest[];
  descriptor: CollectionCorePresentationDescriptor<ActorRow>;
  instance: CollectionCoreInstance;
  presentation: CollectionCorePresentationRuntime;
  row: ActorRow;
} {
  ...
  const descriptor: CollectionCorePresentationDescriptor<ActorRow> = {
    onActivate: createCollectionDetailActivation({
      controller: detail.controller,
      createContent: (actor) => ({
